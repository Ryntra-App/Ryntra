...
fun AnalyticsScreen(
    ...
    LazyColumn(
        ...
        item(key = "analytics-wallet-title", contentType = "heading") {
            RinthySectionLabel(stringResource(R.string.analytics_wallet), modifier = Modifier.padding(top = 18.dp, bottom = 10.dp))
        }
        ...
        if (wallet != null && wallet.transactions.isNotEmpty()) {
            item(key = "analytics-payouts-title", contentType = "heading") {
                RinthySectionLabel(stringResource(R.string.analytics_recent_payouts), modifier = Modifier.padding(top = 18.dp, bottom = 4.dp))
            }
            itemsIndexed(
        ...
        item(key = "analytics-trend-title", contentType = "heading") {
            RinthySectionLabel(stringResource(R.string.analytics_trend), modifier = Modifier.padding(top = 30.dp, bottom = 10.dp))
        ...
        item(key = "analytics-projects-title", contentType = "heading") {
            RinthySectionLabel(stringResource(R.string.analytics_breakdown), modifier = Modifier.padding(top = 30.dp, bottom = 4.dp))
            Text(
        ...
        item(key = "analytics-lifetime-title", contentType = "heading") {
            RinthySectionLabel(stringResource(R.string.analytics_lifetime), modifier = Modifier.padding(top = 30.dp, bottom = 10.dp))
            Text(
        ...
        item(key = "analytics-health-title", contentType = "heading") {
            RinthySectionLabel(stringResource(R.string.analytics_project_health), modifier = Modifier.padding(top = 30.dp, bottom = 8.dp))
        }
