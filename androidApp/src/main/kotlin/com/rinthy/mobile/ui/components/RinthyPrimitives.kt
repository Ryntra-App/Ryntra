...
@Composable
internal fun RinthyProgressIndicator(color: Color, modifier: Modifier = Modifier) {
    val rotation = if (RinthyDesign.motion.isReduced) {
        0f
    } else {
...
@Composable
internal fun RinthySectionLabel(
    text: String,
    modifier: Modifier = Modifier,
) {
    ...
    BasicText(
        ...
        style = RinthyDesign.sectionLabel.copy(
            color = if (isPlatformNative) RinthyDesign.colors.labelSecondary else RinthyDesign.colors.accent,
