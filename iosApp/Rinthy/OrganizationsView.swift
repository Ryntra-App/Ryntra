...
struct OrganizationsView: View {
        ...
        List {
            ...
            Section {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    RinthySectionLabel(text: NSLocalizedString("Managed teams", comment: "Teams section"))
    ...
    private var teamsSummary: some View {
        ...
        .overlay(RoundedRectangle(cornerRadius: 10).stroke(Color.rinthySeparator, lineWidth: 0.5))
    }
...
private struct MemberAvatarStack: View {
    ...
    var body: some View {
        ...
        HStack(spacing: -10) {
            if visible.isEmpty {
                Circle()
                    .fill(Color.rinthyGreen.opacity(0.12))
                ...
                ForEach(Array(visible.enumerated()), id: \.element.user.id) { _, member in
                    ...
                    .frame(width: 28, height: 28)
                    .clipShape(Circle())
                    .overlay(Circle().stroke(Color.rinthySurface, lineWidth: 1.5))
                }
                if members.count > maxVisible {
                    Circle()
                        .fill(Color.rinthySurfaceRaised)
                        .frame(width: 28, height: 28)
                        .overlay {
...
private struct OrganizationDetailView: View {
    ...
    var body: some View {
        List {
            ...
            Section {
                ...
                HStack {
                    RinthySectionLabel(text: NSLocalizedString("Members", comment: "Members section"))
                    Spacer()
    ...
    private func metricChip(value: String, label: String, symbol: String) -> some View {
        HStack(spacing: 8) {
            Image(systemName: symbol).foregroundStyle(Color.rinthyGreen)
        ...
        .padding(.vertical, 10)
        .frame(maxWidth: .infinity)
        .background(Color.rinthySurfaceRaised, in: RoundedRectangle(cornerRadius: 10))
    }
