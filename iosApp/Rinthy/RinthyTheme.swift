...
enum RinthyThemeStyle: String, CaseIterable, Identifiable {
    case platform
    case rinthy

    var id: String { rawValue }
    var label: String { self == .platform ? "Platform" : "Rinthy" }
}

enum RinthyAppearanceMode: String, CaseIterable, Identifiable {
    case system
    case light
    case dark
...
enum RinthyAppLanguage: String, CaseIterable, Identifiable {
    case system
    case english = "en"
    case russian = "ru"
    ...
    static func apply(_ rawValue: String) {
        let language = RinthyAppLanguage(rawValue: rawValue) ?? .system
        switch language {
        case .system:
...
func rinthyExactCount(_ value: Int64) -> String {
...
struct RinthySectionLabel: View {
    ...
    var body: some View {
        Text(LocalizedStringKey(text))
            ...
            .foregroundStyle(isPlatformNative ? Color.secondary : Color.rinthyGreen)
