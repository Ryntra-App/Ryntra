...
private struct ManagedVersionCard: View {
        ...
        VStack(spacing: 0) {
            Button(action: onOpen) {
                ...
                HStack(alignment: .top) {
                    ...
                    Spacer()
                    Label(rinthyExactCount(version.downloads), systemImage: "arrow.down")
                        .font(.caption.bold())
    ...
    private func chip(_ text: String, accent: Bool) -> some View {
        Text(text)
            .font(.caption2.bold())
            .foregroundStyle(accent ? Color.rinthyGreen : Color.primary)
            .padding(.horizontal, 8)
            .padding(.vertical, 5)
            .background(accent ? Color.rinthyGreen.opacity(0.12) : Color.rinthySurfaceRaised, in: RoundedRectangle(cornerRadius: 7))
    }
                ...
                Section("Changelog") {
                    ...
                    if changelogMode == 0 {
                        TextEditor(text: $changelog)
                            ...
                            .background(Color.rinthySurface)
                    } else {
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            HStack {
                                Button {
                                    ...
                                    Image(systemName: primaryFileIndex == index ? "checkmark.circle.fill" : "circle")
                                        .foregroundStyle(primaryFileIndex == index ? Color.rinthyGreen : Color.secondary)
                                }
                                .buttonStyle(.plain)
    ...
    private func loaderChip(_ loader: String) -> some View {
        ...
        return Button {
            ...
            Text(loader.capitalized)
                ...
                .padding(.vertical, 6)
                .background(isSelected ? Color.rinthyGreen.opacity(0.12) : Color.rinthySurfaceRaised, in: RoundedRectangle(cornerRadius: 7))
        }
        .buttonStyle(.plain)
    }
