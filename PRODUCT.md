...
- Generic Material starter templates and default component-demo layouts.
- Corporate dashboard mosaics made from identical statistic cards.
- Glass applied to every content surface, reducing contrast and scan speed.
- Flat, anonymous utility UI with no sense of creator identity.
- Decorative gradients, oversized headings, and motion that delay routine work.

## Design Principles

1. Start with what changed and what needs attention.
...
Target WCAG AA contrast for text and controls. Never communicate status through color alone. Support dynamic type, large text, screen readers, comfortable touch targets, light and dark system themes, and reduced-motion preferences.
